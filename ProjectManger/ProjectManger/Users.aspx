...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="background-color:azure;text-align:center; margin:20px auto;width: 289px;">
        ...
        <table border="1">
            ...
            <tr>
                <td>Roll No: </td>
                <td>
                    <asp:TextBox ID="txtRollNo" runat="server" Width="100%"></asp:TextBox></td>
            </tr>
            <tr>
            <td>User Group: </td>
            <td>
                <asp:DropDownList ID="dbUserGroup" runat="server" Width="100%" DataSourceID="UserGroupData" DataTextField="GrpName" DataValueField="GrpName" OnTextChanged="dbUserGroup_TextChanged" OnSelectedIndexChanged="dbUserGroup_SelectedIndexChanged"></asp:DropDownList>
            ...
            <tr>
                <td>User Type: </td>
                <td>
                    <asp:DropDownList ID="dbUserType" runat="server" Width="100%" DataSourceID="UserTypesData" DataTextField="TypeName" DataValueField="TypeName"></asp:DropDownList>
            ...
            <tr>
                <td>User Project: </td>
                <td>
                    <asp:TextBox ID="txtUserProject" runat="server" Width="100%"></asp:TextBox></td>
